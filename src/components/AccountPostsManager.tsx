...
function previewData(): PostsData {
  return {
    ...
    posts: [
      ...
      { id: "post-5", post_type: "request", owner_state: "closed", title: "Help moving a sofa", category: "Moving help", contact: null, city: "Peotone", state: "IL", website_url: null, description: "Looking for help moving one sofa across town.", status: "approved", admin_notes: null, created_at: "2026-08-01T12:00:00Z", updated_at: "2026-08-11T12:00:00Z" },
    ],
  };
}
