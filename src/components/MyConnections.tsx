  ...
  return (
    <div className="connector-member-shell">
      ...
      <section className="panel connector-add-person" id="add-person">
        <div className="section-heading"><div><p className="eyebrow">Person intake</p><h2>Add a Person</h2><p className="muted">Add only what you know now. They can complete the rest after claiming their profile.</p></div></div>
        <form className="form connector-quick-add-form" onSubmit={(event) => submit(event, "add-person")}>
          <PersonProfileFields intake intro="Required: a first or last name, plus a phone number or email address. Home location is optional." />
