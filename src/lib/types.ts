...
export type LocalSubmission = {
  ...
  request_broad_type: "meals" | "home_help" | "items" | "information" | "other_request" | null;
  request_category_id: string | null;
  request_subcategory_id: string | null;
  request_answers: Record<string, string | number | boolean | string[] | null>;
  service_intent: "one_time" | "ongoing" | null;
  timing_preference: "specific_date" | "date_range" | "within_week" | "as_soon_as_possible" | "flexible" | null;
  requested_date: string | null;
  requested_date_end: string | null;
  time_windows: string[];
  cadence_frequency: string | null;
  cadence_days: string[];
  cadence_time_windows: string[];
  desired_start_period: string | null;
  schedule_flexibility: string | null;
  generated_summary: string | null;
  request_status: "open" | "fulfilled" | "closed" | "cancelled" | null;
  workflow_status: "finding_right_person" | "first_service_scheduled" | "waiting_compatibility_decision" | "trying_another_provider" | "ongoing_relationship_established" | "closed" | "cancelled" | null;
  created_at: string;
  updated_at: string;
};
